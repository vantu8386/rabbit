...
use Marvel\Database\Repositories\TomxuRepository;
...
class ProductController extends CoreController
{
    ...
    public $settings;
    public $tomxurepository;


    public function __construct(ProductRepository $repository, SettingsRepository $settings , TomxuRepository $tomxurepository  )
    {
        $this->repository = $repository;
        $this->settings = $settings;
        $this-> tomxurepository = $tomxurepository;
    }
